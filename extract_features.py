...
def main():
  ...
  for line in training:
    ...
    feature_value_strings = [u'{}: {}'.format(f, features[f]) for f in features.keys()]
...
def extract(source, clusters, a_index, b_index, dependency, add_relation=False):
  ...
  if dependency['head'][a_index]==dependency['head'][b_index]:
    a_relation = u'a_sibling_of_b'
    b_relation = u'b_sibling_of_a'
  elif dependency['head'][a_index]==b_index:
    a_relation = u'a_child_of_b'
    b_relation = u'b_parent_of_a'
  elif dependency['head'][b_index]==a_index:
    a_relation = u'a_parent_of_b'
    b_relation = u'b_child_of_a'

  features[u'gap_size'] = b_index - a_index - 1
  features[u'a_token_'+source[a_index]] = 1
  features[u'b_token_'+source[b_index]] = 1
  features[u'a_cluster_'+clusters[a_index]] = 1
  features[u'b_cluster_'+clusters[b_index]] = 1
  features[u'a_pos_'+dependency['pos'][a_index]] = 1
  features[u'b_pos_'+dependency['pos'][b_index]] = 1
  features[u'a_coarse_'+dependency['coarse'][a_index]] = 1
  features[u'b_coarse_'+dependency['coarse'][b_index]] = 1
  features[u'a_num_siblings'] = dependency['head'].count(dependency['head'][a_index]) - 1
  features[u'b_num_siblings'] = dependency['head'].count(dependency['head'][b_index]) - 1
  ...
  if a_index - 1 > -1:
    features[u'a_-1_token_'+source[a_index-1]] = 1
    features[u'a_-1_pos_'+dependency['pos'][a_index-1]] = 1
    features[u'a_-1_cluster_'+clusters[a_index-1]] = 1
    features[u'a_-1_coarse_'+dependency['coarse'][a_index-1]] = 1
    features[u'a_bigram_'+source[a_index-1]+u'_'+source[a_index]] = 1
  if b_index - 1 > -1:
    features[u'b_-1_token_'+source[b_index-1]] = 1
    features[u'b_-1_pos_'+dependency['pos'][b_index-1]] = 1
    features[u'b_-1_cluster_'+clusters[b_index-1]] = 1
    features[u'b_-1_coarse_'+dependency['coarse'][b_index-1]] = 1
    features[u'b_bigram_'+source[a_index-1]+u'_'+source[b_index]] = 1
  if a_index + 1 < len(source):
    features[u'a_+1_token_'+source[a_index+1]] = 1
    features[u'a_+1_pos_'+dependency['pos'][a_index+1]] = 1
    features[u'a_+1_cluster_'+clusters[a_index+1]] = 1
    features[u'a_+1_coarse_'+dependency['coarse'][a_index+1]] = 1
    features[u'a_bigram_'+source[a_index]+u'_'+source[a_index+1]] = 1
  if b_index + 1 > len(source):
    features[u'b_+1_token_'+source[b_index+1]] = 1
    features[u'b_+1_pos_'+dependency['pos'][b_index+1]] = 1
    features[u'b_+1_cluster_'+clusters[b_index+1]] = 1
    features[u'b_+1_coarse_'+dependency['coarse'][b_index+1]] = 1
    features[u'b_bigram_'+source[b_index]+'_'+source[b_index+1]] = 1
